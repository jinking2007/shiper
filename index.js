...
const UUID = process.env.UUID || '7fd0b88c-c0dd-f400-5fdf-c9151ada7984'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || '9HO9Dw2eZIoihXbTCaxbkF1HLvoqCO7c';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
